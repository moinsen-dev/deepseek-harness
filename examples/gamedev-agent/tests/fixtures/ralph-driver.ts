#!/usr/bin/env node
/** Keyless Loader driver: one fixture turn whose parent runs a Ralph loop —
 *  two fresh children score gauntlet rounds (miss, then pass the bar). */
...
const NAME = 'gamedev-ralph-test-driver'
