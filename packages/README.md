...
| [`game/`](game/README.md) | Game capability family: deterministic game seam, built-in sim games, model-facing play tools, and the gauntlet loop | Product — stable API |
